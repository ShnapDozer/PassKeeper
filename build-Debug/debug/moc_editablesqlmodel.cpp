...
#include <memory>
#include "../../PassKeeper/Support/editablesqlmodel.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_EditableSqlModel_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_EditableSqlModel_t qt_meta_stringdata_EditableSqlModel = {
    {
QT_MOC_LITERAL(0, 16) // "EditableSqlModel"
...
const QMetaObject EditableSqlModel::staticMetaObject = { {
    ...
    qt_meta_stringdata_EditableSqlModel.offsetsAndSize,
    qt_meta_data_EditableSqlModel,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_EditableSqlModel_t
, QtPrivate::TypeAndForceComplete<EditableSqlModel, std::true_type>
